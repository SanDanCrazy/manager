...
public class CsvUtils {
    ...
    public final static String FILE_NAME = "writeCSV.csv";

    public final static String PATH = "D:/"+FILE_NAME;
    ...
    public static void writeCsv(String[] headers, List<String[]> data) throws IOException{
        ...
        printer.flush();
        printer.close();
        System.out.println("CSV文件创建成功，文件路劲："+PATH);
    }

    public static void storyToCsv(List<StoryCsvVO> data) throws IOException{
